...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_3x10(
    ...
    ZALT,    XLOWER,  KC_C,    KC_G,    SRAISE,  KC_N,    KC_M,    KC_V,    KC_B,    KC_RSFT
  ),
  ...
  [_RAISE] = LAYOUT_ortho_3x10(
    ...
    ______,  ______,   KC_BSLS, KC_EQL,  ______,  KC_LBRC, KC_RBRC, KC_COMM, KC_DOT,  ______  
  ),
