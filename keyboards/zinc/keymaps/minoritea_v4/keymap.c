...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      | Ctrl | Win  | Alt  |Space |Space |             | Lower| Lower| Raise| Raise|  F10 | Pause|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      _______, KC_LCTL, KC_LGUI, KC_LALT, _______, KC_SPC,                    LOWER,   _______, RAISE,   _______, KC_F10,  KC_PAUS \
      ),
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_UNDS, KC_EQL,  KC_LCBR, KC_RCBR, KC_COLN, KC_DQUO, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, KC_LABK, KC_RABK, KC_QUES, _______, \
      _______, _______, _______, _______, KC_TAB,  KC_TAB,                    _______, _______, _______, _______, _______, _______ \
      ),
