...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl | Ctrl | Win  | Alt  |Space |Space |             | Raise| Raise|   [  |   ]  |   \  | Pause|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
      KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_ENT,  _______, \
      _______, KC_LCTL, KC_LGUI, KC_LALT, _______, KC_SPC,                    RAISE,   _______, KC_LBRC, KC_RBRC, KC_BSLASH, KC_PAUS \
      ),
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |  F1  |  F2  |  F3  |  F4  |  F5  |             |  F6  | Lett | Down |  Up  | Right| Esc  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |  F7  |  F8  |  F9  |  F10 |  F11 |             |  F12 | Del  |PageDn|PageUp|      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |      |      |      |             |      |      |   +  |  -   |   /  |      |
   * `-----------------------------------------'             `-----------------------------------------'
   */
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ESC, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_DEL,  KC_PGDN, KC_PGUP, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, KC_PLUS, KC_MINS, KC_SLSH, _______ \
      ),
