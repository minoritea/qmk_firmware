...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl | Win  | Alt  |Space |Space | Esc  |             | RAISE| RAISE|   [  |   ]  |   |  | Pause|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_ESC,                    RAISE,  RAISE,    KC_LBRC, KC_RBRC, KC_PIPE, KC_PAUS \
      ),
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, KC_ENT,  KC_ENT,  KC_BSPC,                   _______, _______, _______, _______, _______, _______ \
      ),
