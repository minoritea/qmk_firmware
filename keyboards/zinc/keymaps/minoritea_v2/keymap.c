...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl | Win  | Alt  |Space |Space | Bksp |             | RAISE| RAISE|   [  |   ]  |   |  | Pause|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_BSPC,                   RAISE,  RAISE,    KC_LBRC, KC_RBRC, KC_PIPE, KC_PAUS \
      ),
   ...
   * |   `  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |  -   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |  F1  |  F2  |  F3  |  F4  |  F5  |             |  F6  | Lett | Down |  Up  | Right|  +   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PLUS, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_DEL,  KC_PGDN, KC_PGUP, _______, _______, \
      _______, _______, _______, KC_ENT,  KC_ENT,  KC_ESC,                    _______, _______, _______, _______, _______, _______ \
      ),
