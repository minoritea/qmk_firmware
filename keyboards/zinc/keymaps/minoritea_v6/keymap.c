...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, _______, KC_BSLS,   KC_EQL,                 _______, _______, _______, _______, _______, KC_LBRC, \
      _______, _______, _______, _______, G(KC_SPC), G(KC_SPC),              _______, _______, _______, _______, _______, _______ \
      ),
